...
if (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  ...
  string(TOLOWER "${CMAKE_SYSTEM_PROCESSOR}" LL_SYSTEM_PROCESSOR)
  ...
  if (ADDRESS_SIZE EQUAL 32)
    ...
    if (LL_SYSTEM_PROCESSOR MATCHES "^(aarch64|arm64)$")
      set(ARCH aarch64)
      set(LL_LINUX_ARM64 ON)
...
if (${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
  ...
  # Keep universal as the local default, but honor an architecture selected
  # explicitly by CI (for example the Intel-only portable build).
